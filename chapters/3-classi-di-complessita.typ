...
#theorem(title: "Corollario Teorema di Cook")[
...
#theorem[
  ...
  #proof[
    ...
    / Assunzioni:
      ...
      - $hat(Pi) in "NPc"$: il problema di decisione associato è NP completo (per #link-theorem(<teorema-problema-ottimizzazione-decisione>))
    ...
    Tuttavia abbiamo assunto che $Pi in "NPOc"$, quindi $hat(Pi) in "NPc"$ per #link-theorem(<teorema-problema-ottimizzazione-decisione>).
